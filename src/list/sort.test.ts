...
describe('sortRecipes', () => {
  ...
  it('overall asc puts null last', () => {
    ...
    expect(ids(sortRecipes(withOverall, { ...DEFAULT_STATE, sortKey: 'overall', sortDir: 'asc' }, 1))).toEqual([3, 1, 2]);
  });
  it('rating desc uses visibleRating (collaborative averages, private own-only)', () => {
    ...
    const withRating: Recipe[] = [
      { ...base, id: 1, editors: [2], rating: [{ user: 1, rating: 3 }, { user: 2, rating: 5 }] },
